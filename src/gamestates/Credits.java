...
public class Credits extends State implements Statemethods {
    ...
    private void loadEntities() {
        ...
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.PLAYER_PIRATE), 5, 64, 40), (int) (Game.GAME_WIDTH * 0.05), (int) (Game.GAME_HEIGHT * 0.7)));
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.PLAYER_ORC), 6, 100, 100), (int) (Game.GAME_WIDTH * 0.1), (int) (Game.GAME_HEIGHT * 0.1)));
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.PLAYER_SOLDIER), 6, 100, 100), (int) (Game.GAME_WIDTH * 0.6), (int) (Game.GAME_HEIGHT * 0.3)));
        entitiesList.add(new ShowEntity(getIdleAni(LoadSave.GetSpriteAtlas(LoadSave.ZORO), 8, 32, 32), (int) (Game.GAME_WIDTH * 0.1), (int) (Game.GAME_HEIGHT * 0.3)));
    }
